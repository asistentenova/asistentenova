...
links = {
    ...
    "wikipedia": "https://www.wikipedia.org",  # Enlace a Wikipedia
...
def run_assistant():
    ...
    if 'activar conversación' in rec:
        ...
        elif 'abre a wikipedia' in rec:
            response = open_link("wikipedia")
            response += "\n\n🌟✨ ¡Sumérgete en el mágico mundo del conocimiento! 🌟✨\nAquí encontrarás información de todo tipo, desde historia hasta ciencia. ¡Explora y aprende sin límites!"
        elif 'abre a' in rec:
